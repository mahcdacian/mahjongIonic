...
export const APP_LABELS_EN_CH = {
    ...
    INFO_TEXT3:'If you are deemed the Winner of the game, you will be receiving your Prize at this provided address. Please provide a valid address or P.O Box.  如果您是遊戲的贏家，您將會在提供的地址獲取獎品。 請提供有效地址或郵政信箱。',
    INFO_TEXT4:'Indicates a required field 表示必填字段',
...
export enum APP_LABELS {
    ...
    INFO_TEXT3='INFO_TEXT3',
    INFO_TEXT4='INFO_TEXT4',
